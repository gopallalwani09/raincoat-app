  ...
  return (
    <nav className="bg-white/80 backdrop-blur-lg shadow-sm sticky top-0 z-50 border-b border-gray-100">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <Link to="/" className="text-base sm:text-2xl font-black text-primary tracking-tight flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex space-x-3 sm:space-x-6 items-center font-bold text-gray-700 text-sm sm:text-base">
